...
npm install
cp  /Chakri/git repos/roboshop-shell/catalogue.service /etc/systemd/system/catalogue.service
...
cp   /Chakri/git repos/roboshop-shell/mongo.repo /etc/yum.repos.d/mongo.repo
